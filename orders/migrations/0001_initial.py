# Generated by Django 4.2.24 on 2025-09-05 08:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0004_alter_product_description_alter_product_more_info'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pincode', models.CharField(help_text='Enter 6 digit PIN code', max_length=6, validators=[django.core.validators.RegexValidator('^\\d{6}$', message='Enter a valid 6-digit PIN code')])),
